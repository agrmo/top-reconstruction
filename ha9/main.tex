...
\section*{Problem 4}
This is a two dimensional wave equation. Find $A_j$, $B_j$, and $u(t,r)$.
...
\intertext{Use the orthogonality of $J$ to find $j=k$, and then integrate $J^2$.}
...
\section*{Problem 5}
This is a two dimensional Laplace equation in polar coordinates. Find $A_0$, $A_n$, $B_n$, and $u(r,\theta)$.
...
This is a Cauchy-Euler equation. Solve using the Indicial equation.
\e{r^2 u'' + ru' &= 0\\
r^2 u'' + au' + b&=0 \Rightarrow a=1 \quad b=0}
...
\section*{Problem 8}
This is a two dimensional Laplace equation in polar coordinates with Robin boundary conditions. Find $B_n$, and the time-independent solution $u(r,\theta)$.
\e{r(r,\theta)&=\sum_{n=1}^\infty B_n r^{n \pi \theta_0^{-1}} \sin(n \pi \theta_0^{-1} \theta)\\
&= \sum_{n=1}^\infty B_n r^{4n} \sin(4n\pi)}
Differentiate and apply boundary conditions.
\e{\fr{\p}{\p r}u(r,\theta)=\sum_{n=1}^\infty B_n 4n r^{4n-1} \sin(4n\theta)}
\e{\fr{\p}{\p r}u(1,\theta)=\sum_{n=1}^\infty B_n 4n r^{4n-1} \sin(4n\theta)=\sin(\theta)}
This is Fourier series for $\sin(\theta)$. Expand the Fourier series, and solve for $B_n$.
...
&= \fr{4}{\pi (1-16n^2)}((1+4n)\sin(\fr{\pi}{4})\cos(n\pi) - \cos(\fr{\pi}{4})\sin(n\pi))-(1-4n)(\sin(\fr{\pi}{4})\cos(n\pi) +\cos(\fr{\pi}{4})\sin(n\pi))\\
...
\e{\boxed{B_n=\fr{8(-1)^n}{4\pi(1-16n^2)2^{1/2}}}}
Apply $B_n$ to the solution for $u(r,\theta)$.
\e{\boxed{u(r,\theta)=\sum_{n=1}^\infty \fr{8(-1)^n}{4\pi(1-16n^2)2^{1/2}} r^{4n} \sin(4n\theta)}}
\end{document}
